 ...
 */
function OutputExtension(activity, context, assignType) {
...
OutputExtension.prototype.activate = function activate() {
  this.activity.broker.subscribeTmp('event', 'activity.end', this._onEndHandler, {
    noAck: true,
...
OutputExtension.prototype.onEnd = function onEnd(_routingKey, message) {
  ...
  switch (this.assignType) {
    case 'id':
      ...
      break;
    case 'auto':
      if (output !== null && typeof output === 'object' && !Array.isArray(output)) Object.assign(environmentOutput, output);else environmentOutput[id] = output;
      break;
  }
};